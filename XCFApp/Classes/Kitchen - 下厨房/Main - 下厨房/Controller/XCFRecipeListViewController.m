...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[XCFRecipeCell class] forCellReuseIdentifier:recipeListCellIdentifier];
    ...
    [self.mananger GET:XCFRequestKitchenRecipeList
        ...
        self.recipeListHeader = [[XCFRecipeListHeader alloc] initWithFrame:CGRectMake(0, 0, XCFScreenWidth, self.recipeList.headerheight)];
